...
class AsrModel(nn.Module):
    def __init__(
        ...
        self.f0_fft1 = FFTBlock(d_model=1024, d_inner=1024, n_head=4, d_k=1024, d_v=1024, l_n=2, cln_ffd=False, dropout=0.1)
        ...
        self.pitch_joint = FFTBlock(d_model=1024, d_inner=1024, n_head=4, d_k=1024, d_v=1024, l_n=6, cln_ffd=False, dropout=0.1)
    ...
    def forward(
        ...
        # h = h.transpose(1, 2)
        # print('after att:', f0.shape, h.shape)
        ...
        # C. FFT
        encoder_out = self.pitch_joint(encoder_out, non_pad_mask=f0_mask, slf_attn_mask=None)
