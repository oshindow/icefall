...
from finetune_hubert_transducer.train_phone_model_pitjoiner_merge_unet_w2v import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    encoder_out = model.unet(input=pitch, condition=encoder_out)
    hyps = []
