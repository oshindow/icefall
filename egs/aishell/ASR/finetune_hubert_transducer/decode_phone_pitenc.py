...
from finetune_hubert_transducer.train_phone_model_pitenc import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    uv = batch['customs']['uv'].long().to(device)
    ...
    pitch_embedding = model.pitch_encoder(pitch)
    uv_embedding = model.uv_encoder(uv)
