...
from model_zip_f0_conv_rmf0 import AsrModel
...
from conformer_ctc.transformer import Noam
...
def run(rank, world_size, args):
    ...
    # model = Conformer(encoder=encoder)
    print(model)
