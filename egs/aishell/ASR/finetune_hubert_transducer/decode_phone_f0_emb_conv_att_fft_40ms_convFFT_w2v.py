...
from finetune_hubert_transducer.train_phone_model_f0_emb_conv_att_fft_40ms_convFFT import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    encoder_out = encoder_out + f0_emb
    encoder_out = model.layer_norm2(encoder_out)
    dec_local_output = encoder_out
    for enc_layer in model.pitch_joint:
