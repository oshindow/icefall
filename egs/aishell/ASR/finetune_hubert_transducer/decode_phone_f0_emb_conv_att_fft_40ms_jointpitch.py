...
from finetune_hubert_transducer.train_phone_model_f0_emb_conv_att_fft_40ms_jointpitch import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    encoder_out = model.project_hubert(encoder_out) + model.project_pitch(f0_emb)
