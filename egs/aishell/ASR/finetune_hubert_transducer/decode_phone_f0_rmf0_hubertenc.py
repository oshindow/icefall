...
from finetune_hubert_transducer.train_phone_model_f0_rmf0 import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    f0 = batch['customs']['f0'][0].to(device)
