...
from asr_datamodule_new_5ms import AishellAsrDataModule
...
from finetune_hubert_transducer.train_phone_model_f0_emb_conv_att_fft_5ms import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    h = h.transpose(1, 2)
    h = model.f0_fft2(h, non_pad_mask=f0_mask, slf_attn_mask=None)
    h = h.transpose(1, 2)
    ...
    h = h.transpose(1, 2)
    h = model.f0_fft3(h, non_pad_mask=f0_mask, slf_attn_mask=None)
    h = Mish()(h)
    h = h.transpose(1, 2)
