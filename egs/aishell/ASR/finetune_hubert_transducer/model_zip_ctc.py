...
class AsrModel(nn.Module):
    ...
    def forward_ctc(
        ...
        return ctc_loss, encoder_out, ctc_output 
    ...
    def forward(
        ...
        # print(encoder_out.shape, encoder_out_lens.shape, encoder_out_lens)
        ...
        if self.use_ctc:
            # Compute CTC loss
            targets = y.values
            encoder_out, ctc_output, _ = self.forward_ctc(
                encoder_out=encoder_out,
                encoder_out_lens=encoder_out_lens,
                targets=targets,
                target_lengths=y_lens,
            )
            return encoder_out, ctc_output, _
        else:
