...
from finetune_hubert_transducer.train_phone_model_f0_emb_conv_att_mask import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    f0 = f0.transpose(1, 2)
    h, subsampled_f0_mask = model.f0_encoder(f0, f0_mask) 
