...
from finetune_hubert_transducer.train_phone_model_f0_emb_conv_att_fft_40ms_FFT import get_params, get_transducer_model
...
def decode_one_batch(
    ...
    encoder_out = model.pitch_joint(encoder_out, non_pad_mask=f0_mask, slf_attn_mask=None)
