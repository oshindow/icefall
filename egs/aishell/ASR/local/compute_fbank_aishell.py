...
def compute_fbank_aishell(
    ...
    with get_executor() as ex:  # Initialize the executor only once.
        for partition, m in manifests.items():
            ...
            # if whisper_fbank:
            #     storage_path = f"{output_dir}/{prefix}_whisper_feats_{partition}",
            #     out_path = output_dir / f"{prefix}_whisper_cuts_{partition}.{suffix}"
            # else:
            #     storage_path=f"{output_dir}/{prefix}_feats_{partition}",
            #     out_path = output_dir / f"{prefix}_cuts_{partition}.{suffix}"
