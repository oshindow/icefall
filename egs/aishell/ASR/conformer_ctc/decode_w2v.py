...
from conformer_w2v import Conformer
...
def decode_one_batch(
    ...
    nnet_output, att_loss = model(feature, feature_lens,
                                                         y=unsorted_token_ids, 
    ...
    supervision_segments = torch.stack(
        (
            ...
            supervisions["start_sample"] // 640,
            supervisions["num_samples"] // 640
        ),
        1,
    ).to(torch.int32)
...
def decode_dataset(
    ...
    for batch_idx, batch in enumerate(dl):
        ...
        phone_ids = graph_compiler2.texts_to_ids(texts) # latic
...
def main():
    ...
    encoder = get_encoder_model(params=params)
