...
class Transformer(nn.Module):
    ...
    def forward(
        self, x: torch.Tensor, x_lens: torch.testing, is_training=False, supervision: Optional[Supervisions] = None
