...
from model_rnn import AsrModel
from tdnn_rnn import TdnnLstmEncoder, TdnnLstmDecoder
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    ...
    # )
    encoder = TdnnLstmEncoder(num_features=80, num_classes=1024, num_lstms=6, subsampling_factor=1)
    return encoder


def get_decoder_model(params: AttributeDict) -> nn.Module:
    # decoder = Decoder(
    #     vocab_size=params.vocafb_size,
    #     decoder_dim=params.decoder_dim,
    #     blank_id=params.blank_id,
    #     context_size=params.context_size,
    # )
    decoder = TdnnLstmDecoder(num_features=params.decoder_dim, num_classes=params.vocab_size, num_lstms=2, blank_id=params.blank_id, subsampling_factor=1)
    return decoder

    # six-layer LSTM encoder with 1,024 units each and a
    # two-layer LSTM prediction network with the same number of
    # units.
